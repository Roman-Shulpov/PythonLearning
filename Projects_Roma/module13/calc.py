...
# (10 отжиманий за 1 ошибку ввода)
#
    ...
    while True:
        ...
        if choice_number == 1:
            ...
            if validate_input_number(x) and validate_input_number(y) and validate_input_number(z):
                result = calculate_parallelepiped_area(int(x), int(y), int(z))
...
# СВОИ ТЕСТОВЫЕ ПРОВЕРКИ......................................
########################################################################################################################
# result = add_numbers(123, 178)
# print(result)